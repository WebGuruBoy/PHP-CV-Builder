...
<div class="task-board">
	...
	<div class="row">
		<div class="dg-title text-row">
			<span class="button dg-edit"><i class="fas fa-edit "></i></span>
			<div class="dg-wrap">
				<div class="dg-name">
					<div class="dg-name-frame">
						<h2><?php echo $userdata['firstname']." ".$userdata['lastname'];?></h2>
					</div>	
				</div>
				<div class="dg-name-down">
				</div>
			</div>
			
		</div>
		<span class="button dg-edit"><i class="fas fa-edit "></i></span>
		<div class="dg-wrap dg-wrap-13">
		<div class="dg-contact">
			<div class="singlecolumn">
				<div>
					<span id="FIELD_HPHN" class="field"><?php echo $userdata['phone'];?> </span>
					<span id="FIELD_EMAI" class="field"><?php echo $userdata['email'];?></span>
		...
		<div class="dg-right-side-13 col-sm-8">
		...
		<div class="dg-left-side-13 col-sm-4">
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper13.css">
