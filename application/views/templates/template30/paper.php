...
<div class="col-sm-12">
	<div class="dg-name-contact">
		<div class="text-row ui-sortable-handle">
			...
			<div class="dg-wrap">
				<div class="cv-title">
					<h4 style="margin-bottom: 30px;"><?php echo $userdata['firstname'];?> <span><?php echo $userdata['lastname'];?></span></h4>
				</div>
				<div class="dg-contact">
					<span><?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></span><span>, </span><span> <?php echo $userdata['phone'];?></span><span> , </span><span><?php echo $userdata['email'];?></span>
				</div>
			</div>
		</div>
	</div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper30.css">
