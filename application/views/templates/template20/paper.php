			...
			<section class="wrapper">
				...
				<div class="paragraph firstparagraph">
					<div class="text-row ui-sortable-handle">
						...
						<div class="dg-wrap row">
							<div class="name20 col-sm-7" >
								<span class="fieldfirst"><?php echo $userdata['firstname'];?></span>
								<span class="fieldlast"><?php echo $userdata['lastname'];?></span>
							</div>
							<div class="dg-contact col-sm-4">
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper20.css">
