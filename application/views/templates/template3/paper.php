...
<div class="col-sm-12">
	<div class="dg-name-contact">
		<div class="text-row ui-sortable-handle">
			...
			<div class="dg-wrap">
				<div style="border-bottom: 1px solid #000;margin-bottom: 1px;padding: 12px 0px 10px;border-top: 1px solid">
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper3.css">
