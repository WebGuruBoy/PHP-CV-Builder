		...
		<div class="text-row ui-sortable-handle">
			...
			<div class="dg-wrap">
				...
				<div class="dg-contact">
					<div><span><?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></span></div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper26.css">
