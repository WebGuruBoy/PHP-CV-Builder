...
<div class="row">
<div class="col-sm-12 cv-padding">
		...
		<div class="text-row ui-sortable-handle">
			...
			<div class="dg-wrap">
				...
				<div class="dg-contact">
					<div><span><?php echo $userdata['phone'];?></span><span>|</span><span><?php echo $userdata['email'];?></span></div>
					<div><?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></div>
				</div>
			</div>
		</div>
	</div>
	<div class="dg-main-under">
		<ul class="sortable ui-sortable addablePart" id="sort1">
			<li class="text-row ui-sortable-handle summaryPart">
				<div class="heading">
					<img id="pdf-circle" src="<?php echo $this->baseurl. IMAGE_PATH."1.jpg";?>" width="12px" height="12px">
...
<input type="hidden" id="circletype">
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper28.css">
