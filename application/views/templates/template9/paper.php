...
<div class="col-sm-12">
	...
	<div class="dg-name-contact">
			<div class="text-row">
				<span class="button dg-edit dg-10"><i class="fas fa-edit "></i></span>
				<div class="dg-wrap">
					<div class="dg-name">
						<h2><?php echo $userdata['firstname']." ".$userdata['lastname'];?></h2>
					</div>
					<div class="dg-contact">
						<div><b>Phone : <?php echo $userdata['phone'];?></b> <b>Email : <?php echo $userdata['email'];?></b> <b>Address : <?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></b></div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper9.css">
