...
<div class="col-sm-12">
	<div class="row dg-main-side">
		<div class="col-sm-2 dg-space">
			<img class='' src="<?php echo $this->baseurl;?>assets/images/cv.png"/>
		</div>
	<div class="dg-name-contact col-sm-7">
			<div class="text-row">
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper12.css">
