	...
	<ul class="sortable ui-sortable addablePart" id="sort1"  data-status-id="1">
		<li class=" text-row ui-sortable-handle summaryPart">
			...
			<div class="section">
				...
				<img id="pdf-circle" src="<?php echo $this->baseurl. IMAGE_PATH."1.jpg";?>" width="12px">
				<div class="paragraph">
		...
		<li class="text-row ui-sortable-handle cv-acc">
			...
			<div class="section">
				...
				<img id="pdf-circle" src="<?php echo $this->baseurl. IMAGE_PATH."1.jpg";?>" width="12px">
				<div class="paragraph">
					<div class="field singlecolumn tpl29-single dg-wrap cv-modified">
...
<input type="hidden" id="splittype">
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper29.css">
