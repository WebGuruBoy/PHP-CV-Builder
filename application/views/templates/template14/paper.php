...
<div class="task-board">
	...
	<div class="row">
		<div class="dg-title text-row">
			<div class="dg-top"><span class="dg-shap">CV</span></div>
		...
		<div class="dg-left-side-14 col-sm-4">
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper14.css">
