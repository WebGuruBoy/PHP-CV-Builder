...
<div class="col-sm-12">
	<div class="dg-name-contact">
		<div class="text-row ui-sortable-handle">
			...
			<div class="dg-wrap">
				<div class="cv-title">
					<h4 style="margin-bottom: 30px;"><?php echo $userdata['firstname']." ".$userdata['lastname'];?></h4>
				</div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper27.css">
