...
<div class="col-sm-12">
	<div class="row dg-main-side">
		<div class="dg-photo col-sm-4">
			<div class="previewer">
				<img class='img-upload photo' src="<?php echo $this->baseurl;?>assets/images/default_avatar.jpg"/>
				<div class="btn-wrap">
		...
		<div class="dg-name-contact col-sm-8">
...
<input type="hidden" id="misc1" value="1">
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper1.css">
