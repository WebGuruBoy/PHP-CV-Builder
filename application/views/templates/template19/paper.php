			...
			<div class="text-row">
				...
				<div class="dg-wrap">
					...
					<div class="dg-contact">
						<div class="dg-cont"><b>Phone : <?php echo $userdata['phone'];?></b> &nbsp<b>Email : <?php echo $userdata['email'];?></b>&nbsp <b>Address : <?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></b></div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper19.css">
