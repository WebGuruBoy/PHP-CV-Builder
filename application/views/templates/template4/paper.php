...
<div class="col-sm-12">
	<div class="dg-name-contact">
		<div class="text-row">
			...
			<div class="dg-wrap">
				<div style="border-bottom: 1px solid #4f8dff;margin-bottom: 1px;padding: 12px 0px 10px;border-top: 1px solid #4f8dff">
					<h4><?php echo $userdata['firstname']." ".$userdata['lastname'];?></h4>
				</div>
				<div style="border-bottom: 3px solid #4f8dff;"></div>
				<div class="dg-contact">
					<span><?php echo $userdata['street'].", ".$userdata['city'].", ".$userdata['country']." ".$userdata['postcode'];?></span>&nbsp;&nbsp;<span><?php echo $userdata['phone'];?></span>&nbsp;&nbsp;<span><?php echo $userdata['email'];?></span>
				</div>
			</div>
		</div>
	</div>
...
<link rel="stylesheet" href="<?php echo $this->config->item('base_url').CSS_PATH;?>template/paper4.css">
